...
public:
	...
	static void PlaySound(const uint16_t __code *audioPattern);
	...
	static void DrawBitmap(int16_t sx, int16_t sy, const uint8_t *bitmap,const uint8_t *alpha);
        /*
	...
	static void DrawSprite0(int16_t x, int16_t y, const uint8_t *bitmap, uint8_t frame);	
        */
