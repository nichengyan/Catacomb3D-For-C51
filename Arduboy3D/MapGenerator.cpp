...
uint8_t MapGenerator::GetDistanceToCellType(uint8_t x, uint8_t y, CellType::Value cellType)
{
	uint8_t ringWidth = 3;
...
void MapGenerator::Generate()
{
	...
	// Add monsters
	{
		...
		uint8_t monstersToSpawn = EnemyManager::maxEnemies;
                CellType::Value monsterType = CellType::Monster;
		uint8_t minSpacing = 3;
	...
	// Add blocking decorations
	{
		uint8_t attempts = 255;
		uint8_t toSpawn = 255;
                CellType::Value cellType = CellType::Urn;
		uint8_t minSpacing = 3;
	...
	// Add treasure / items
	{
		uint16_t attempts = 65535;
		uint8_t toSpawn = 8;
                CellType::Value cellType = CellType::Chest;
		uint8_t minSpacing = 3;
